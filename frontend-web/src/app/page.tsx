...
import { Button, Input, AuthFooter } from '@/components/common';
				...
				<form onSubmit={handleSubmit(onSubmit)} className="relative z-10 flex min-h-screen items-center justify-center flex-col">
					...
					<div className="w-full max-w-sm rounded-lg bg-white p-8 shadow-md">
						...
						<div className="text-center mt-6 space-y-2">
							...
							<p className="text-xs text-gray-600 mt-6">Não tem uma conta? <a href="/register" className="text-xs text-accent hover:underline">
								Registre-se
							</a></p>
						</div>
					</div>
